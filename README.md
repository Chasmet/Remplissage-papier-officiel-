...
Depuis la version 1.12.0, l’application détecte les zones de saisie, génère une image-guide séparée et transmet des `field_id` stables. ChatGPT choisit le champ selon son libellé; le serveur place ensuite le contenu sur l’ancre exacte mesurée par Android. Les coordonnées libres restent disponibles uniquement pour les zones sans repère fiable.
